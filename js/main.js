...
/* harmony import */ var _components_animation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/animation.js */ "./src/js/components/animation.js");
/* harmony import */ var _components_animation_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_animation_js__WEBPACK_IMPORTED_MODULE_3__);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const scrollAnimation = () => {
    ...
    scrollItems.forEach(el => {
      let scrollOfset = el.offsetTop + el.offsetHeight / 100;
...
const formSentBtn = document.querySelector('.questions__submit');
const formSent = document.querySelector('.questions__form-sent');
const formSentClose = document.querySelector('.form-sent__close');
...
new window.JustValidate('.questions__form', {
  ...
  submitHandler: function (thisForm) {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        if (xhr.status === 200) {
          formSent.classList.add('questions__form-sent--active');
          scrollDisable();
          darkBg.classList.add('dark-bg--active');
          formSentClose.addEventListener('click', () => {
            formSent.classList.remove('questions__form-sent--active');
            scrollActive();
...
const servicesCard = document.querySelectorAll('.modal-window');
const modalClose = document.querySelectorAll('.card-modal__close');
const modalWindow = document.querySelectorAll('.services__card-modal');
const darkBg = document.querySelector('.dark-bg');
const body = document.querySelector('.page__body');
const scrollDisable = () => {
  body.classList.add('scrollOff');
...
servicesCard.forEach(el => {
  el.addEventListener('click', function (e) {
    this.nextElementSibling.classList.add('services__card-modal--active');
    darkBg.classList.add('dark-bg--active');
    scrollDisable();
  });
});
modalClose.forEach(el => {
  el.addEventListener('click', function (e) {
    modalWindow.forEach(el => {
      el.classList.remove('services__card-modal--active');
      darkBg.classList.remove('dark-bg--active');
      scrollActive();
    });
  });
...
const heroSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero__swiper', {
  ...
  pagination: {
    el: '.swiper-progressbar-hero',
    type: 'progressbar'
  }
});
const sliderAllSlide = document.querySelector('.image-slider__total');
const sliderCurrentSlide = document.querySelector('.image-slider__current');
sliderAllSlide.innerHTML = heroSwiper.slides.length - 2;
heroSwiper.on('slideChange', function () {
  let currentSlide = ++heroSwiper.realIndex;
